...
r = iw(f, im, a, b, t(a, b, 5))
println(r)

r = iw(f, it, a, b, t(a, b, 5))
println(r)

r = iw(f, in, a, b, t(a, b, 5))
println(r)



r = iw(f, im, a, b, t(a, b, 7))
println(r)

r = iw(f, it, a, b, t(a, b, 7))
println(r)

r = iw(f, in, a, b, t(a, b, 7))
println(r)



r = iw(f, im, a, b, t(a, b, 9))
println(r)

r = iw(f, it, a, b, t(a, b, 9))
println(r)

r = iw(f, in, a, b, t(a, b, 9))
println(r)